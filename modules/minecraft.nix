        ...
        servers.survival = {
          ...
          symlinks = with pkgs; {
            mods = linkFarmFromDrvs "mods" (
              builtins.attrValues {
                worldedit = fetchurl {
                  url = "https://cdn.modrinth.com/data/1u6JkXh5/versions/SisHd23s/worldedit-mod-7.3.18.jar";
                  sha512 = "683ae6bc80fa61c9b6d2af8897e249bb8bf5b0d934e7ea22f9790fd6c4c86f94fc6fa1ed837d8879b676f56ceedaa02a5627509358ff2e966175740060add2a4";
                };
              }
            );
          };
